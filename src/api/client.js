...
function buildHintPromptQuestion(role, question, expectedAnswer, level) {
...
export async function getHint(question, expectedAnswer, level) {
    //adresa la care e trimisa cererea HTTP
    ...
    const data = {
        ...
        messages: [
            ...
            {
                role: "user",
                content: buildHintPromptQuestion(
                    question,
                    expectedAnswer,
                    level
                ),
...
export async function checkAnswer(question, userAnswer, actualAnswer) {
    ...
    const data = {
        ...
        messages: [
            ...
            {
                role: "user",
                content: buildCheckAnswerPromptQuestion(
                    question,
                    userAnswer,
                    actualAnswer
                ),
